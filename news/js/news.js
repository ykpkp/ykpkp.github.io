	...
	methods:{
      ...
      success: function (data) {
		...
		replace(){
			...
			gamenews.newpostvue.content = gamenews.newpostvue.content.replace(gamenews.newpostvue.images[i].position,'<img src= "/img/loading.gif" data-lazy-src="'+ gamenews.newpostvue.images[i].imgSrc + '"style="width: 100%;padding: 5% 10%;">')  
			}
		},
		hidemodle(){
			$("#newsmodal").hide();
